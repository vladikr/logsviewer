...
const NodeTabs: React.FunctionComponent<NodeTabsProps> = ({uuid}: NodeTabsProps) => { 
...
return (
    <div>
        ...
        role="region"
      >
            <Tab eventKey={0} title={<TabTitleText>YAML</TabTitleText>} aria-label="Node Yaml" tabContentId={`tabContent${0}`} />
